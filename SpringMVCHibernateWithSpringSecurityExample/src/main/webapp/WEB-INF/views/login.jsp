        ...
        <div class="container">
            <div class="row no-gutters slider-text justify-content-start align-items-center">
                ...
                <div class="col-lg-4 col-md-6 mt-0 mt-md-5 d-flex">
                    ...
                    <form action="${loginUrl}" method="post" class="request-form ftco-animate">
                        <c:if test="${param.error != null}">
                            <div class="alert alert-danger">
                                <p>Nombre de usuario invalido o contraseña</p>
                            </div>
                        </c:if> 
                        ...
                        <div class="form-group">
                            <input type="submit" value="Ingresar" class="btn btn-primary py-3 px-4" value="Log in">
                        </div>
                    </form>
                </div>
            </div>
